 ...
 private void Navigation()
{
    ...
    if (nav != null && nav.transform.childCount > 0)
    {
    ...
    {
        // Debug: Log an error message when nav or its child transforms are not found.
        Debug.LogError("No child transforms found under nav or nav is null.");
    }
}
